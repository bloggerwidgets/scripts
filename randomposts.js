...
(function(nr) {
	let tablica = [];
	let skrypt = document.querySelectorAll('script[src="https://cdn.jsdelivr.net/gh/bloggerwidgets/scripts@1/randomposts.js"]')[nr];
